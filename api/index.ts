...
<section id="packages" class="py-12 px-4 sec-lavender">
  <div class="max-w-5xl mx-auto">
    ...
    <!-- Section-level single WhatsApp CTA -->
    <div class="mt-6 text-center">
      <p class="text-sm text-gray-500 mb-3" t-en="Ready to book any of these packages?" t-ja="ご予約をご希望ですか？" t-zh="准备好预约任意套餐了吗？" t-ko="패키지 예약을 원하시나요?">Ready to book any of these packages?</p>
      <button onclick="openWA()" class="btn-wa px-8 py-3.5 text-sm">
        <i class="fab fa-whatsapp text-lg"></i>
        <span t-en="Inquire &amp; Book via WhatsApp" t-ja="WhatsAppでお問い合わせ・ご予約" t-zh="WhatsApp咨询预约" t-ko="WhatsApp으로 문의·예약">Inquire &amp; Book via WhatsApp</span>
      </button>
    </div>
  </div>
</section>
